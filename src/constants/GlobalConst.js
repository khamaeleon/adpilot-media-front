...
const media = 'http://map-vpn.iptime.org:8081/'
const admin = 'http://map-vpn.iptime.org:8089 '
const auth = 'http://map-vpn.iptime.org:8091'
const dev = 'http://192.168.0.90:8081/'

export const ADMIN_SERVER = admin

export const AUTH_SERVER = auth

export const MEDIA_SERVER = dev
