        ...
        <BoardTap>
          <BoardTableContainer>
            <table>
              ...
              <tr>
                <td
                  className={'border-r'}>{historyDetailInfoState !== null && historyDetailInfoState.previousRevision ? historyDetailInfoState.previousRevision.publish ? '개제중' : '게재중지' : '-'}</td>
          ...
          <BoardTableContainer>
            <table>
              ...
              <tr>
                ...
                <td
                  className={'border-r'}>{historyDetailInfoState !== null && historyDetailInfoState.previousRevision !== null && historyDetailInfoState.previousRevision.noExposedConfigType + '(' + historyDetailInfoState.previousRevision.noExposedConfigValue + ')'}</td>
